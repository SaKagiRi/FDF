...
FILE_S2		= bind.c key.c readconfig.c variable.c default.c FILE_S3		= drawline.c mlxinit.c texture.c projection.c math.c cache.c control_function.c utils_function.c set_color.c
